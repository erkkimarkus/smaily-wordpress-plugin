...
- **Erkki / business:** `TESTING.md` pilot-acceptance plan (duration, real data,
  go/no-go — a business decision); the (a) TODOs above (profiling opt-in if AKI
  tightens; privacy-policy profiling mention; the fail-open GDPR-window review).
